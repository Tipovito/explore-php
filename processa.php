...
//para investirgar variáveis e expressões
//var_dump($_POST);

//CONECTA AO BANCO E GRAVA OS DADOS EM (inseert com PDO )
try {
    ...
    (nome, email, sexo, telefone, senha, idade, estado,
    cidade, destinos, hospedagem, mensagem, dt_cadastro)
    value(:nome, :email, :sexo, :telefone, :senha, :idade, :estado,
    :cidade, :destinos, :hospedagem, :mensagem, :dt_cadastro)');
    $sql->execute(array(
         ':nome' => $nome,
         ':email' => $email,
